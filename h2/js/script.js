...
$(".sub-nav-gallery").sticky({ topSpacing: 51, center:true,  className:"sub-nav-pined" });
...
$(".search-option-flash").click(function(){
...
$(".tab1 .tab-caption li").click(function(){
	
	$('.tab1 .tab-caption li').attr("data-active","off") ;	
	$('.tab1 .tab-caption li[data-li="'+ $(this).attr("data-li") +'"]').attr("data-active","on") ;	
	
	$('.tab1 .tab-body ol').attr("data-active","off") ;	
	$('.tab1 .tab-body ol[data-li="'+ $(this).attr("data-li") +'"]').attr("data-active","on") ;	
	 
});

 
 
 $(".tab_2 .tab-caption li").click(function(){
	
	$('.tab_2 .tab-caption li').attr("data-active","off") ;	
	$('.tab_2 .tab-caption li[data-li="'+ $(this).attr("data-li") +'"]').attr("data-active","on") ;	
	
	$('.tab_2 .tab-body ol').attr("data-active","off") ;	
	$('.tab_2 .tab-body ol[data-li="'+ $(this).attr("data-li") +'"]').attr("data-active","on") ;	
	 
});

 
 
 $(".tab3 .tab-caption li").click(function(){
	
	$('.tab3 .tab-caption li').attr("data-active","off") ;	
	$('.tab3 .tab-caption li[data-li="'+ $(this).attr("data-li") +'"]').attr("data-active","on") ;	
	
	$('.tab3 .tab-body ol').attr("data-active","off") ;	
	$('.tab3 .tab-body ol[data-li="'+ $(this).attr("data-li") +'"]').attr("data-active","on") ;	
...
$(".tl-li").hover(function(){
	...
	//$(".tl-li[data-adad=" + parseInt($(this).attr("data-adad")-1) + "]").css("background-image", "none");
	$(".tl-li").removeClass("nav2lihover");
	$(this).addClass("nav2lihover");
	
		$(".nav2lihover").each(function(){
			$(this).find(".sub-nav").fadeIn();
			
			<!--$(".tl-li").css("background-image", "url('./img/border-nav.png')");-->
			<!--$(".tl-li[data-adad=" + parseInt($(this).attr("data-adad")-1) + "]").css("background-image", "none");-->
		});
	
  }, function(){
    $(this).find(".sub-nav").fadeOut();
	//$(".tl-li[data-adad=" + parseInt($(this).attr("data-adad")-1) + "]").css("background-image", "url('./img/border-nav.png')");
}); 		
